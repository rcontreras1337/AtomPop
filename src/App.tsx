...
const CalculatorCard = ({ icon, title, description, color, examples }: CalculatorCardProps) => {
  const colorClasses = {
    amber: {
  ...
  return (
    <motion.div
      ...
      whileTap={{ scale: 0.99 }}
      className={`group card-glass cursor-pointer transition-all duration-300 ${classes.border} ${classes.glow}`}
    >
